...
3. Ejecuta el proyecto en el archivo `ForoHubChallenge.java`.
...
Para acceder a la documentación de la API REST para la ejecución de los endpoints, ir al navegador web y acceder al enlac: `http://127.0.0.1:8080/swagger-ui/index.html`
